...
Looking at the venn diagrams, it is clear that there were certain combinations that did not work. For example, Salmon and DESeq2 was not very successful in recognizing the expression of the genes in the sample. There were only two genes that were recognized as being significant over the threshold as up or down-regulated. Looking at the venn diagrams also helped us understand how conservative the aligners were, meaning which aligner identified the fewest genes. All of the aligners paired with Limma showed the most conservativeness compared to the other DE programs. The Salmon and Bowtie aligners identified the very similar numbers of genes in each DE program case, with Limma being the most conservative, followed by DESeq2 and then EdgeR. In the Kallisto and Sailfish aligners, DESeq2 was less conservative than EdgeR. 

It is difficult to determine what is too conservative or not conservative enough. This is one of the obstacles in RNA sequencing studies because it is very situational and conservativess might differ in different data sets being examined.  
Either certain aligners don't play well with certain programs, OR there was a user error. 
