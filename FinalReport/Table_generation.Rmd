...
library(venn)
#bowtie2
venn_bowtie2_list <- list(bowtie = subset(bowtie2_venn, DE == "DESeq2")$GeneName, edgeR = subset(bowtie2_venn, DE == "edgeR")$GeneName, limma = subset(bowtie2_venn, DE == "limma")$GeneName)
venn_bowtie2_plot <- venn(venn_bowtie2_list, show.plot=TRUE)

#kallisto
venn_kallisto_list <- list(bowtie = subset(kallisto_venn, DE == "DESeq2")$GeneName, edgeR = subset(kallisto_venn, DE == "edgeR")$GeneName, limma = subset(kallisto_venn, DE == "limma")$GeneName)
venn_kallisto_plot <- venn(venn_kallisto_list, show.plot=TRUE)

#salmon
venn_salmon_list <- list(bowtie = subset(salmon_venn, DE == "DESeq2")$GeneName, edgeR = subset(salmon_venn, DE == "edgeR")$GeneName, limma = subset(salmon_venn, DE == "limma")$GeneName)
venn_bowtie2_plot <- venn(venn_bowtie2_list, show.plot=TRUE)

#sailfish
venn_sailfish_list <- list(bowtie = subset(sailfish_venn, DE == "DESeq2")$GeneName, edgeR = subset(sailfish_venn, DE == "edgeR")$GeneName, limma = subset(sailfish_venn, DE == "limma")$GeneName)
