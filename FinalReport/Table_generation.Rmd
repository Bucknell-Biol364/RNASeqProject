...
aligners_venn_read <- lapply(list("venn_figs/sailfishvenn.png", "venn_figs/bowtievenn.png", "venn_figs/kallistovenn.png", "venn_figs/salmonvenn.png"), png::readPNG)
combo_alignersvenn <- lapply(aligners_venn_read, grid::rasterGrob)
do.call(gridExtra::grid.arrange, combo_alignersvenn)
```
