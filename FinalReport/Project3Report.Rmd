...
## My Results
```{r}
knitr::include_graphics("figures/JustinKoss.UpandDownRegGraph.png") 
```
...
Here is the MA plot for kallisto-egeR pipeline.

```{r downregulated gene-picture} 
knitr::include_graphics("figures/MA_kallisto_edgeR.png") 
```

Here is the table for up and down regulated genese using kallisto-edgeR pipeline.

```{r}
read.csv("tables/julie_kallisto_edgeR_final.csv", header=TRUE) 
```
