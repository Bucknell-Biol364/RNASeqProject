...
sailfish_EdgeR_MA <- knitr::include_graphics("figures/JustinKoss.sailfish.edgeR.png") 
sailfish_limma_MA <- knitr::include_graphics("figures/Ritter_DEBrowser_image.png") 
sailfish_DESeq2_MA <- knitr::include_graphics("figures/Vogel_Sailfish_DESeq2_MAplot.png") 
sailfish_EdgeR_MA
=======
##limma
...
kallisto_limma_MA
salmon_limma_MA
>>>>>>> c3c7173c56d73c0bd8885d1d25c4fddc44f02020
sailfish_limma_MA
```
