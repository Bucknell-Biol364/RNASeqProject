...
Alligners:
  ...
  6) Kallisto will output two files called tabular and HDF5. The tabular file contains transcriptomic data and should be used in subsequent analyses on differential expression. The HDF5 file contains binary data and is not used here. 
